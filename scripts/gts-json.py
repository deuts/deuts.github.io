...
# Convert EARLIEST_DATE to datetime object for comparison (Philippine time, 00:00:00)
earliest_datetime = datetime.strptime(EARLIEST_DATE, "%Y-%m-%d")
earliest_datetime = earliest_datetime.replace(tzinfo=timezone(timedelta(hours=8)))  # Set timezone to Manila (UTC +8)
